...
export const buttonElement = 'inline-flex items-center justify-center space-x-2 py-2 px-4 border border-gray-300 bg-[#ebebeb] hover:bg-[#ebebeb] focus:outline-none focus:ring-4 focus:ring-gray-200 rounded-3xl transition-colors duration-150';
