<script>
  ...
  const linkStyles = "py-2 px-4 text-xs cursor-pointer focus:outline-none focus:ring-4 focus:ring-gray-200 rounded-lg hover:bg-[#ebebeb] daark:hover:bg-slate-700";
