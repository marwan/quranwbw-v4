	...
	<div class="my-6 space-y-4 pb-4">
		<div class="text-sm">
			...
			<ul class="list-disc ml-5 space-y-2">
				...
				<li><a class={linkClasses} target="_blank" rel="noreferrer" href="http://recitequran.com">ReciteQuran.com </a> for their word by word audio files orginally recited by <a class={linkClasses} target="_blank" rel="noreferrer" href="https://twitter.com/WisamSharieff/">Imam Wisam Sharieff</a>.</li>
				...
				<li><a class={linkClasses} target="_blank" rel="noreferrer" href="https://zoopernet.com">Ayman Siddiqui</a> for all the help including providing various website datas and fonts & website testing.</li>
				...
				<li><a class={linkClasses} target="_blank" rel="noreferrer" href="https://play.google.com/store/apps/details?id=com.atq.quranemajeedapp.org.islamone&hl=en">Usman Pervez (IslamOne android app)</a> for the Urdu words database.</li>
