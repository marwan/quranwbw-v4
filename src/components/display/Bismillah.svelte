...
{:else if $__currentPage === 'page'}
	<div class="bismillah flex flex-col text-center leading-normal flex-wrap space-y-4 block md:mt-6 text-[5vw] md:text-[32px] lg:text-[36px] font-filter {$__wordType === 2 && $__tajweedEnabled ? 'theme-palette-tajweed' : 'theme-palette-normal'}">
