<script>
	...
	export let defaultClass = `font-medium py-2 px-4 text-sm ${window.theme('hover')}`;
...
## Props
@prop export let defaultClass: string = 'font-medium py-2 px-4 text-sm {window.theme('hover')}';
