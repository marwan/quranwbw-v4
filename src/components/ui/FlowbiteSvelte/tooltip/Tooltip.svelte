<script>
	...
	const types = {
		...
		light: `border-blackkk/10 ${window.theme('background')} text-grayyy-900`,
		auto: ` ${window.theme('background')} text-grayyy-900 dark:bg-grayyy-700 dark:text-white border-blackkk/10 dark:border-grayyy-700`,
		custom: ''
	};
	let toolTipClass;
	$: {
