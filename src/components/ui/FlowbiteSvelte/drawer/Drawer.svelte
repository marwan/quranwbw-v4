<script>
	...
	export let divClass = `overflow-y-auto z-50 p-4 ${window.theme('background')}`;
...
@prop export let divClass: string = 'overflow-y-auto z-50 p-4 ${window.theme('background')} dark:bg-grayyy-800';
