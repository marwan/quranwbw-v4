...
<button id="mushafMinimalModeButton" type="button" title="Minimal Mode" class="opacityyy-70 inline-flex flex-col items-center justify-center px-5 group {window.theme('hover')}" on:click={toggleMushafMinimalMode}>
	<Maximize />
