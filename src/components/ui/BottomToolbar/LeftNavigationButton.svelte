...
<a href="/{linkHref}" class="inline-flex flex-col items-center justify-center px-5 rounded-s-full group {window.theme('hover')} {linkDisabled ? disabledClasses : 'opacityyy-70'}">
	<ChevronLeft />
