<script>
	...
	const radioClasses = `inline-flex justify-between items-center py-2 px-4 w-full text-grayyy-500 ${window.theme('background')} rounded-lg border ${window.theme('border')} cursor-pointer peer-checked:border-primary-600 peer-checked:text-primary-600 hover:text-grayyy-600 hover:bg-grayyy-100`;
					...
					<div class="flex flex-row space-x-4">
						...
						<div class="flex flex-row space-x-2">
							...
							<input
								...
								class="w-16 text-xs border {window.theme('border')} rounded-3xl focus:ring-grayyy-500 focus:${window.theme('border')} block p-2.5 mb-0"
								placeholder="end"
							/>
						</div>
					</div>
		...
		<div class="flex flex-col space-y-4 py-4 border-t {window.theme('border')}">
			<div class="flex flex-row space-x-4">
				<div class="flex flex-row space-x-2">
					...
					<input id="timesToRepeat" type="number" bind:value={$__audioSettings.timesToRepeat} min="1" max="20" on:change={updateAudioSettings} class="w-16 text-xs border {window.theme('border')} rounded-3xl focus:ring-grayyy-500 focus:${window.theme('border')} block p-2.5 mb-0" />
