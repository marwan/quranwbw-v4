	...
	<div class="relative w-full max-w-md max-h-full">
		...
		<div class="relative bg-white rounded-3xl shadow daaark:bg-gray-700">
			...
			<div class="px-6 py-6 space-y-8 lg:px-8">
				...
				<div class="">
					<textarea id="notes-value" rows="8" value={verseNote} class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-3xl border border-gray-300 focus:ring-gray-500 focus:border-blue-500 daaark:bg-gray-700 daaark:border-gray-600 daaark:placeholder-gray-400 daaark:text-white daaark:focus:ring-gray-500 daaark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
				</div>
