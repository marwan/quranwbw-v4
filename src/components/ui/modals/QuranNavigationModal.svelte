...
<Modal id="quranNavigationModal" title="Navigate" bind:open={$__quranNavigationModalVisible} size="sm" class="rounded-3xl text-black theme" bodyClass="p-2 !border-t-0" headerClass="hidden" placement="center">
