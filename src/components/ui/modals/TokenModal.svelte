        ...
        {/if} -->
                ...
                <Email />
						...
						<div class="flex flex-col space-y-4">
							...
							<!-- delete token button -->
							<button id="delete-token" on:click={() => deleteToken()} class="w-full bg-gray-600 text-white hover:bg-[#ebebeb] {buttonElement}">
