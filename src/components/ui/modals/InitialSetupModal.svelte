	...
	<div class="relative w-full max-w-2xl max-h-full sm:mx-auto h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
		...
		<div class="max-h-full overflow-hidden flex flex-col bg-white rounded-3xl shadow dark:bg-gray-700">
			...
			<div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
				...
				<button on:click={() => toggleModal('initial-setup-modal', 'hide')} type="button" class="text-gray-400 bg-transparent hover:bg-lightGray hover:text-gray-900 rounded-3xl text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-lightGray dark:hover:text-white">
				...
				<div class="flex flex-row space-x-6">
					<div class="flex flex-col">
						...
						<select
							...
							class="w-32 border border-gray-300 text-gray-900 rounded-3xl focus:ring-gray-500 focus:border-gray-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-slate-400 dark:focus:ring-gray-500 dark:focus:border-gray-500"
						>
