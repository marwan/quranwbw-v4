<script>
	...
	const selectorClasses = `w-32 border ${window.theme('border')} text-left rounded-3xl focus:ring-grayyy-500 focus:${window.theme('border')} focus-within:ring-2 block p-2.5 truncate font-normal`;
