<script>
  ...
  const buttonClasses = "inline-flex items-center justify-center w-10 h-10 text-gray-400 transition-colors duration-150 rounded-md focus:shadow-outline bg-[#ebebeb] hover:bg-gray-200 print:hidden";
</script>
