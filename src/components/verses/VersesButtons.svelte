...
<div class="verseButtons flex flex-row space-x-2 text-gray-400 text-xs grayscale">
    ...
    <div class="{verseDropdownVisible === true ? 'block' : 'hidden'} verse-dropdown absolute right-0 z-10 mt-2 min-w-max origin-top-right bg-white divide-y divide-gray-100 rounded-3xl shadow w-44 dark:bg-gray-700">
