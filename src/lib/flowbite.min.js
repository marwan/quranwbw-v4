	...
	return (function () {
		...
		var t = {
				...
				853: function (t, e, i) {
					...
					var it = {
							...
							fn: function (t) {
								...
								null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, et(Object.assign({}, l, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s, roundOffsets: c })))),
					...
					function kt(t, e, i) {
						...
						var n,
							...
							d = { x: 0, y: 0 };
						return (r || (!r && !i)) && (('body' !== A(e) || ut(a)) && (l = (n = e) !== T(n) && j(n) ? { scrollLeft: (o = n).scrollLeft, scrollTop: o.scrollTop } : lt(n)), j(e) ? (((d = V(e, !0)).x += e.clientLeft), (d.y += e.clientTop)) : a && (d.x = dt(a))), { x: c.left + l.scrollLeft - d.x, y: c.top + l.scrollTop - d.y, width: c.width, height: c.height };
					}
					function At(t) {
						var e = new Map(),
							i = new Set(),
				...
				902: function (t, e) {
					...
					var n = { alwaysOpen: !1, activeClasses: 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-slate-400', inactiveClasses: 'text-gray-500 dark:text-gray-400', onOpen: function () {}, onClose: function () {}, onToggle: function () {} },
						o = (function () {
							function t(t, e) {
				...
				33: function (t, e) {
					...
					var n = { defaultPosition: 0, indicators: { items: [], activeClasses: 'bg-white dark:bg-gray-800', inactiveClasses: 'bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800' }, interval: 3e3, onNext: function () {}, onPrev: function () {}, onChange: function () {} },
						o = (function () {
							function t(t, e) {
								void 0 === t && (t = []), void 0 === e && (e = n), (this._items = t), (this._options = i(i(i({}, n), e), { indicators: i(i({}, n.indicators), e.indicators) })), (this._activeItem = this.getItem(this._options.defaultPosition)), (this._indicators = this._options.indicators.items), (this._intervalDuration = this._options.interval), (this._intervalInstance = null), this._init();
							}
							return (
								(t.prototype._init = function () {
									var t = this;
				...
				340: function (t, e) {
					...
					var n = { placement: 'left', bodyScrolling: !1, backdrop: !0, edge: !1, edgeOffset: 'bottom-[60px]', backdropClasses: 'bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-30 custom-backdrop', onShow: function () {}, onHide: function () {}, onToggle: function () {} },
						o = (function () {
							function t(t, e) {
					...
					function s() {
						...
						document.querySelectorAll('[data-drawer-target]').forEach(function (e) {
							...
							if (s) {
								...
								r(i, t) || t.push({ id: i, object: new o(s, { placement: a || n.placement, bodyScrolling: c ? 'true' === c : n.bodyScrolling, backdrop: l ? 'true' === l : n.backdrop, edge: d ? 'true' === d : n.edge, edgeOffset: u || n.edgeOffset }) });
					...
					function c() {
						document.querySelectorAll('[data-dropdown-toggle]').forEach(function (t) {
							...
							if (i) {
								...
								new a(i, t, { placement: n || s.placement, triggerType: c || s.triggerType, offsetSkidding: o ? parseInt(o) : s.offsetSkidding, offsetDistance: r ? parseInt(r) : s.offsetDistance, delay: l ? parseInt(l) : s.delay, ignoreClickOutsideClass: d || s.ignoreClickOutsideClass });
				...
				16: function (t, e) {
					...
					var n = { placement: 'center', backdropClasses: 'bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40 custom-backdrop', backdrop: 'dynamic', closable: !0, onHide: function () {}, onShow: function () {}, onToggle: function () {} },
						o = (function () {
							function t(t, e) {
				...
				247: function (t, e) {
					...
					var n = { defaultTabId: null, activeClasses: 'text-gray-600 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-500 border-gray-600 dark:border-gray-500', inactiveClasses: 'dark:border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300', onShow: function () {} },
						o = (function () {
							function t(t, e) {
		...
		return (
			(function () {
				...
				new h.default('load', [e.initAccordions, r.initCollapses, o.initCarousels, a.initDismisses, l.initDropdowns, d.initModals, c.initDrawers, p.initTabs, f.initTooltips, u.initPopovers, s.initDials]).init(),
					(t.default = { Accordion: e.default, Carousel: o.default, Collapse: r.default, Dial: s.default, Drawer: c.default, Dismiss: a.default, Dropdown: l.default, Modal: d.default, Popover: u.default, Tabs: p.default, Tooltip: f.default, Events: h.default });
			})(),
			n
		);
	})();
